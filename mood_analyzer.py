...
class MoodAnalyzer:
    ...
    def preprocess(self, text: str) -> List[str]:
        ...
        # Strip leading/trailing punctuation from each token so "good," matches
        # "good". Emojis are not in string.punctuation, so they survive intact.
        tokens = [t.strip(string.punctuation) for t in tokens]
        # Drop anything that became empty after stripping (e.g. bare "...")
